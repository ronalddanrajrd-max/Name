...
async def setup(bot):
    ...
    @app_commands.command(name="reglement", description="Envoyer le règlement")
    async def reglement(self, interaction: discord.Interaction):
        ...
        embed = discord.Embed(
            ...
            description=(
                ...
                "En utilisant nos scripts, vous acceptez ce règlement."
            ),
            color=0x000000
        )
        ...
        embed.add_field(
            ...
            value=(
                "• Partage de script interdit\n"
                "• Partage de key interdit\n"
                "• Revente interdite\n"
                "• Leak = blacklist"
            ),
            inline=False
